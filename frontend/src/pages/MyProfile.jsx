...
const MyProfile = () => {
  ...
  return (
    <div className='max-w-lg flex flex-col gap-2 text-sm'>
      ...
      <div>
        <p className='text-neutral-500 underline mt-3'>CONTACT INFOMATION</p>
      ...
      <p className='font-medium'>Address:</p>
      {
        isEdit
        ? <p>
          <input className='bg-gray50' value={userData.address.line1} onChange={(e) => setUserData(prev=>({...prev, address: { ...prev.address, line1: e.target.value }}))} type="text" />
          <br />
